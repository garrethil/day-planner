...
// Clear all saved tasks from local storage when the clear button is clicked
...
// Save button for any hour is clicked the text element is saved to local storage
...
// check if the hour block is less than the hour or equal to the hour to apply according classes.
// Otherwise the futere class is applied.
  ...
  //get any saved tasks from local storage and set the text element to the saved string value
  ...
  // set the time element in the header to show the month, day, year at hours:minutes:seconds
  ...
  // call functions to render page properly
